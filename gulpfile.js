...
var srcDir     = jetpack.cwd('client/src');
var distDir    = jetpack.cwd('client/dist');

gulp.task('build', ['copy', 'concat-css'], function () {

    return browserify('./client/src/main')
...
gulp.task('concat-css', ['vendor-css', 'home-css'], function () {

    gulp.src([
        'client/dist/css/*.css',
        'client/dist/css/angular-material.min.css'
    ])
